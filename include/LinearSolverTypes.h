...
typedef Tpetra::FECrsGraph< LocalOrdinal, GlobalOrdinal, Node>             FEGraph;
...
typedef Tpetra::FEMultiVector<Scalar,LocalOrdinal,GlobalOrdinal,Node>      FEMultiVector;
...
typedef Tpetra::FECrsMatrix<Scalar, LocalOrdinal, GlobalOrdinal, Node>     FEMatrix;
